...
class TestOneHundred(TestCase):
    ...
    def test_straight(self):
        ...
        self.assertEqual(100.00, round(Op.straight([2, 3, 4, 5, 6], 6), 2))
...
class TestSpecialCases(TestCase):
    ...
    def test_four(self):
        self.assertEqual(100.00, round(Op.four([4, 4, 4, 4, 4], 4), 2))

    def test_three(self):
        self.assertEqual(100.00, round(Op.three([4, 4, 4, 4, 4], 4), 2))

    def test_pair(self):
        self.assertEqual(100.00, round(Op.pair([4, 4, 4, 4, 4], 4), 2))
